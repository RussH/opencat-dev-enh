...
/* Candidate Access Level Constants */
define('CANDIDATE_PORTAL_LOGO',    'http://96.45.190.9/images/emaillogo.jpg');
define('CANDIDATE_PORTAL_LOGO_SMALL',  'images/candidate_portal_logo.jpg');
define('CANDIDATE_PORTAL_SUBTEXT', 'Candidate Portal');
define('CANDIDATE_PORTAL_PAGE_TITLE', 'Clear Road IT Candidate Portal');
