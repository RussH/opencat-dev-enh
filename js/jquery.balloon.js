...
;(function($) {
	...
	$.fn.balloon = function(options) {
		...
		return this.one("mouseenter", function(e) {
			...
			$target.unbind("mouseenter").showBalloon(options).mouseenter(function(e) {
	...
	$.fn.showBalloon = function(options) {
		...
		return this.each(function() {
			...
			if(contents && contents != $balloon.html()) $balloon.html(contents);
			...
			//if(options.default_visible == 0) $target.hideBalloon();
		});
	};
	...
	$.balloon = {
		defaults: {
			...
			position: "top", offsetX: 0, offsetY: 0, tipSize: 12, minLifetime: 200,
