                    ...
                    <tr>
                        <td width="50%" height="100%" valign="top">
                            ...
                            <table class="editTable" width="100%" height="285">
                                <tr>
                                    <td class="tdVertical">
                                        <label id="nameTitleLabel" for="nameTitle">Name Title:</label>
                                    </td>
                                    <td class="tdData">
								...
								<tr>
                                    ...
                                    <td class="tdData">
                                        <input type="checkbox" id="IsHiringMgr" name="IsHiringMgr"/>&nbsp;
                                    </td>
                                </tr>
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="technologies" id="technologies" value="" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td class="tdVertical">
                                        <label id="WebProfileLabel" for="web_profile">Web Profile:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="web_profile" id="web_profile" value="" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
