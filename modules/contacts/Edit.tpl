                    ...
                    <tr>
                        <td width="50%" height="100%" valign="top">
                            ...
                            <table class="editTable" width="100%" height="285">
                                <tr>
									<td class="tdVertical">
										<label id="titleLabel" for="title">Name Title:</label>
									</td>
									<td class="tdData">
										<select id="nameTitle" name="nameTitle" class="inputbox" style="width:150px;">
											<option value=""></option>
											<option <?php if ($this->nameTitle == 'Mr.') { echo "selected"; } ?> value="Mr.">Mr.</option>
											<option <?php if ($this->nameTitle == 'Mrs.') { echo "selected"; } ?> value="Mrs.">Mrs.</option>
											<option <?php if ($this->nameTitle == 'Ms.') { echo "selected"; } ?> value="Ms.">Ms.</option>                                
										</select>
									</td>
								</tr>
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="IsHiringMgrLabel" for="IsHiringMgr">Hiring Manager?:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="checkbox" id="IsHiringMgr" name="IsHiringMgr"<?php if ($this->data['IsHiringMgr'] == 1): ?> checked<?php endif; ?> />&nbsp;
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="TechnologiesLabel" for="technologies">Technologies:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="technologies" id="technologies" value="<?php $this->_($this->data['technologies']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td class="tdVertical">
                                        <label id="WebProfileLabel" for="technologies">Web Profile:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="web_profile" id="web_profile" value="<?php $this->_($this->data['web_profile']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td class="tdVertical">
                                        <label id="CallPlanLabel" for="call_plan">Call Plan:</label>
                                    </td>
                                    <td class="tdData">
                                        <select id="call_plan" class="selectBox" name="call_plan" style="width: 150px;">
                                         <option value=""></option>
                                         <option value="Week1" <?php if($this->data['call_plan']=='Week1') echo('selected="selected"'); ?>>Week1</option>
                                         <option value="Week2" <?php if($this->data['call_plan']=='Week2') echo('selected="selected"'); ?>>Week2</option>
                                         <option value="Week3" <?php if($this->data['call_plan']=='Week3') echo('selected="selected"'); ?>>Week3</option>
                                         <option value="Week4" <?php if($this->data['call_plan']=='Week4') echo('selected="selected"'); ?>>Week4</option>
                                        </select>
                                    </td>
                                </tr>
