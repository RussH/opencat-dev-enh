                ...
                <tr style="vertical-align:top;">
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            ...
                            <tr>
                                <td class="vertical">Technologies:</td>
                                <td class="data"><?php $this->_($this->data['technologies']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Web Profile:</td>
                                <td class="data"><a href="<?php $this->_($this->data['web_profile']); ?>" target="_blank"><?php $this->_($this->data['web_profile']); ?></a></td>
                            </tr>
							<tr>
                                <td class="vertical">Call Plan:</td>
                                <td class="data"><?php $this->_($this->data['call_plan']); ?></td>
                            </tr>
							<tr>
                                <td class="vertical">Hiring Manager?:</td>
                                <td class="data"><?php $this->_($this->data['IsHiringMgr']); ?></td>
                            </tr>
                    ...
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            <tr>
                                <td class="vertical">Name Title:</td>
                                <td class="data"><?php $this->_($this->data['nameTitle']); ?></td>
                            </tr>
                ...
                <?php foreach ($this->activityRS as $rowNumber => $activityData): ?>
                    <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                        ...
                        <td align="left" valign="top" id="activityNotes<?php echo($activityData['activityID']); ?>">
							<?php if ($activityData['dataItemType'] == DATA_ITEM_MESSAGING_CONTACT) { ?>
								<a href="<?php echo(CATSUtility::getIndexName()); ?>?m=messaging&a=show&messageID=<?php $this->_($activityData['message_id']); ?>"><?php $this->_($activityData['notes']); ?></a>
							<?php } else { 
								$this->_($activityData['notes']);
							} ?>
						</td>
                        <td align="center" >
                            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
