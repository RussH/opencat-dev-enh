        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) {echo($this->data['title']);} else {echo('Job Orders: Job Order Details');}?></h2></td>
                </tr>
            </table>

            <p class="note"><?php if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) {echo('Job Details');} else {echo('Job Order Details');}?></p>
                ...
                <tr style="vertical-align:top;">
                    ...
                    <td width="50%">
                        <table class="detailsInside" height="100%">
                            <tr><td class="vertical">Title:</td>
                                <td class="data" width="300">
                                    <span class="<?php echo($this->data['titleClass']); ?>"><?php $this->_($this->data['title']); ?></span>
                                </td></tr>
                            <tr><td class="vertical">Created:</td>
                                <td class="data"><?php $this->_($this->data['dateCreated']); ?> </td></tr>                            
                            <tr><td class="vertical">Location:</td>
                                <td class="data"><?php $this->_($this->data['cityAndState']); ?></td></tr>
                            <tr><td class="vertical">Openings:</td>
                                <td class="data"><?php $this->_($this->data['openings']); if ($this->data['openingsAvailable'] != $this->data['openings']): ?> (<?php $this->_($this->data['openingsAvailable']); ?> Available)<?php endif; ?></td></tr>
                        </table>
                    </td>
                    <td width="50%">&nbsp;</td>
                    <?php } else { ?>
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            ...
                            <tr><td class="vertical">Company Name:</td>
                                <td class="data">
                            ...
                            <tr><td class="vertical">Department:</td>
                                <td class="data">
                                    <?php echo($this->data['department']); ?>
                                </td></tr>
                            <tr><td class="vertical">CATS Job ID:</td>
                                <td class="data" width="300"><?php $this->_($this->data['jobOrderID']); ?></td></tr>
                            <tr><td class="vertical">Company Job ID:</td>
                                <td class="data"><?php echo($this->data['companyJobID']); ?></td></tr>
                            <tr><td class="vertical">Contact Name:</td>
                                <td class="data">
                            ...
                            <tr><td class="vertical">Contact Phone:</td>
                                <td class="data"><?php echo($this->data['contactWorkPhone']); ?></td></tr>
                            <tr><td class="vertical">Contact Email:</td>
                                <td class="data">
                                    <a href="mailto:<?php $this->_($this->data['contactEmail']); ?>"><?php $this->_($this->data['contactEmail']); ?></a>
                                </td></tr>
                            <tr><td class="vertical">Location:</td>
                                <td class="data"><?php $this->_($this->data['cityAndState']); ?></td></tr>
                            <tr><td class="vertical">Max Rate:</td>
                                <td class="data"><?php $this->_($this->data['maxRate']); ?></td></tr>
                            <tr><td class="vertical">Salary:</td>
                                <td class="data"><?php $this->_($this->data['salary']); ?></td></tr>
                            <tr><td class="vertical">Start Date:</td>
                                <td class="data"><?php $this->_($this->data['startDate']); ?></td></tr>
                    ...
                    <td width="50%" height="100%" style="vertical-align:top;" >
                        <table class="detailsInside" height="100%">
                            <tr><td class="vertical">Duration:</td>
                                <td class="data"><?php $this->_($this->data['duration']); ?></td></tr>
                            <tr><td class="vertical">Openings:</td>
                                <td class="data"><?php $this->_($this->data['openings']); if ($this->data['openingsAvailable'] != $this->data['openings']): ?> (<?php $this->_($this->data['openingsAvailable']); ?> Available)<?php endif; ?></td></tr>
                            <tr><td class="vertical">Type:</td>
                                <td class="data"><?php $this->_($this->data['typeDescription']); ?></td></tr>
                            <tr><td class="vertical">Status:</td>
                                <td class="data"><?php $this->_($this->data['status']); ?></td></tr>
                            <tr><td class="vertical">Pipeline:</td>
                                <td class="data"><?php $this->_($this->data['pipeline']) ?></td></tr>
                            <tr><td class="vertical">Submitted:</td>
                                <td class="data"><?php $this->_($this->data['submitted']) ?></td></tr>
                            <tr><td class="vertical">Days Old:</td>
                                <td class="data"><?php $this->_($this->data['daysOld']); ?></td></tr>
                            <tr><td class="vertical">Created:</td>
                                <td class="data"><?php $this->_($this->data['dateCreated']); ?> (<?php $this->_($this->data['enteredByFullName']); ?>)</td></tr>
                            <tr><td class="vertical">Recruiter:</td>
                                <td class="data"><?php $this->_($this->data['recruiterFullName']); ?></td></tr>
                            <tr><td class="vertical">Owner:</td>
                                <td class="data"><?php $this->_($this->data['ownerFullName']); ?></td></tr>
                ...
                <tr>
                    <td>
                        <table class="detailsInside">
                        	<?php if(intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE) { ?>
                                <tr><td valign="top" class="vertical">Attachments:</td>
                            ...
                            <tr>
                            	<?php if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) { ?>
                                	<td valign="top" class="vertical">Job Description:</td>
                                    <td class="data" colspan="2">
                                        <?php if($this->data['description'] != ''): ?>
                                        <div id="shortDescription" style="overflow: auto; border: #AAA 1px solid; padding:5px;">
							...
							<?php if(intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE) { ?>
                                <tr><td valign="top" class="vertical">Internal Notes:</td>
...
<?php if (!$this->isPopup && intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE): ?>
            <div id="actionbar">
...
<?php if (!$this->isPopup): ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && !isset($this->frozen)): ?>
                ...
                <a href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&a=addToPipeline&getback=getback&candidateID=<?php echo($_SESSION['CATS']->getCandidateID());?>&candidateIDArrayStored=0&jobOrderID=<?php echo($this->jobOrderID); ?>', 410, 125, null); return false;">
                    <img src="images/consider.gif" width="16" height="16" class="absmiddle" alt="add candidate" border="0" />&nbsp;Apply to Job</a>                &nbsp;|&nbsp;
                <a href="index.php?m=joborders">Back to Jobs</a>
                <?php }?>
            <?php endif; ?>
        </div>
    </div>
