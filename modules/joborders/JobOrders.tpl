        ...
        <div id="contents"<?php echo !$this->totalJobOrders ? ' style="background-color: #E6EEFF; padding: 0;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td><h2><?php if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) {echo('Current Job Openings');} else {echo('Job Orders: Home');}; ?></h2></td>
            ...
            <p class="note">
                ...
                <?php } else { ?>
                    <span style="float:left;">Current Job Openings -
                        Page <?php echo($this->dataGrid->getCurrentPageHTML()); ?>
                        (<?php echo($this->dataGrid->getNumberOfRows()); ?> Job Postings)                        
                    </span>                
                <?php } ?>
                <span style="float:right;">
                    <?php $this->dataGrid->drawRowsPerPageSelector(); ?>
                    <?php if(intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE) { $this->dataGrid->drawShowFilterControl();} ?>
                </span>&nbsp;
            </p>
