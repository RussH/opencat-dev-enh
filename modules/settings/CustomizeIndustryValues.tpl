...
<?php TemplateUtility::printTabs($this->active, ''); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <p class="note">Customize Industry pulldown values</p>

            <form name="editSettingsForm" id="editSettingsForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeIndustryValues" method="post">
              ...
              <table class="sortable" width="920">
                ...
                <script type="text/javascript">
                   ...
                   var inlineEditIDCounter = 0;
                    ...
                    <?php foreach (array(array("name" => "Industries", "RS" => $this->extraFieldSettingsCompaniesRS, "type" => DATA_ITEM_COMPANY)) as $index => $data): ?>
                        <tr>
                                ...
                                <table class="sortable" width="560" id="extraFieldsTable<?php echo($index); ?>">
                                    ...
                                    <?php foreach($data['RS'] as $rsIndex => $rsData): ?>
                                        <tr class="<?php TemplateUtility::printAlternatingRowClass($rsIndex); ?>" id="table<?php echo($index); ?>row<?php echo($rsIndex); ?>">
                                            <td>
                                                <a href="javascript:void(0);" onclick="deleteRow<?php echo($index); ?>(<?php echo($rsIndex); ?>, urlDecode('<?php echo(urlencode($rsData['industry'])); ?>'));"  style="padding:0px;">
