                    ...
                    <td width="100%">
                        ...
                        <table class="searchTable" width="100%">
                            ...
                            <tr>
                                <td>
                                    <img src="images/bullet_black.gif" alt="" />
                                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=specializationPanel">
                                        Specialization/Role 
                                    </a>
                                </td>
                                <td>
                                    Manage specialization/role table entry
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <table class="searchTable" width="100%">
                            ...
                            <tr>
                                <td>
                                    <img src="images/bullet_black.gif" alt="" />
                                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeIndustryValues">
                                        Customize Industry Values
                                    </a>
                                </td>
                                <td>
                                    Edit Industry pulldown values.
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img src="images/bullet_black.gif" alt="" />
                                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeCategoryValues">
                                        Customize Company Category Values
                                    </a>
                                </td>
                                <td>
                                    Edit Company Category pulldown values.
                                </td>
                            </tr>
                        </table>
                        <br />
