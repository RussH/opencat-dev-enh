                    ...
                    <td>
                        <form name="emailSettingsForm" id="emailSettingsForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=emailSettings" method="post">
                            ...
                            <table class="editTable" width="700">
                                ...
                                <tr>
                                	<td class="tdVertical" style="width: 175px;">
                                        <label for="signature" id="signatureLabel">Email Signature:</label>
                                    </td>
                                    <td class="tdData">
                                        <textarea class="inputbox" name="signature" id="signature" style="width:450px; height:100px"><?php $this->_($this->mailerSettingsRS['signature']); ?></textarea>
                                    </td>
                                </tr>
                                <tr>
