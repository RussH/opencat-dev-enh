<?php /* $Id: CustomizeIndustryValues.tpl 3660 2007-11-19 18:26:19Z brian $ */ ?>
...
<?php TemplateUtility::printTabs($this->active, ''); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <p class="note">Customize Category pulldown values</p>

            <form name="editSettingsForm" id="editSettingsForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeCategoryValues" method="post">
              ...
              <table class="sortable" width="920">
                ...
                <script type="text/javascript">
                   ...
                   var inlineEditIDCounter = 0;
                    ...
                    <?php foreach (array(array("name" => "Categories", "RS" => $this->extraFieldSettingsCompaniesRS, "type" => DATA_ITEM_COMPANY)) as $index => $data): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <table class="sortable" width="560" id="extraFieldsTable<?php echo($index); ?>">
                                    ...
                                    <?php foreach($data['RS'] as $rsIndex => $rsData): ?>
                                        <tr class="<?php TemplateUtility::printAlternatingRowClass($rsIndex); ?>" id="table<?php echo($index); ?>row<?php echo($rsIndex); ?>">
                                            <td>
                                                <a href="javascript:void(0);" onclick="deleteRow<?php echo($index); ?>(<?php echo($rsIndex); ?>, urlDecode('<?php echo(urlencode($rsData['category'])); ?>'));"  style="padding:0px;">
                                ...
                                <div id="addFieldOption<?php echo($index); ?>">
                                    <a href="javascript:void(0);" onclick="document.getElementById('addField<?php echo($index); ?>').style.display=''; document.getElementById('addFieldOption<?php echo($index); ?>').style.display='none'; document.getElementById('addFieldName<?php echo($index); ?>').value=''; document.getElementById('addFieldName<?php echo($index); ?>').focus();">
                                        <img src="images/actions/add_small.gif" border="0" />&nbsp;Add new <?php echo($data['name']); ?>
                                    </a>
                                </div>
                                <br />
                                <br />
