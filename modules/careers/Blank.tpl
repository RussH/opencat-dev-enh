...
<html>
    <head>
        ...
        <title><?php echo 'Clear Road IT Job: '.($this->template['page_title']); ?></title>
    ...
    <div style="text-align:center;">
        ...
        <div id="poweredCATS">
		<a href="http://www.catsone.com" target="_blank"><img width="120" src="http://www.clearroad.it/cats/images/LINUX-powered.png" alt="Powered by: CATS - Applicant Tracking System" title="Powered by: CATS - Applicant Tracking System" /></a>
		</div>
    </div>
