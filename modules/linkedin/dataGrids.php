...
class LinkedInByViewDataGrid extends LinkedInDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        $this->_defaultColumns = array( 
            array('name' => 'In DB', 'width' => 10),
            array('name' => 'First Name', 'width' => 80),
            array('name' => 'Last Name', 'width' => 80),
            array('name' => 'Company', 'width' => 135),
            array('name' => 'Job Title', 'width' => 135),
            array('name' => 'Business Phone', 'width' => 85),
...
class LinkedInListByViewDataGrid extends LinkedInDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        /* Pager configuration. */
