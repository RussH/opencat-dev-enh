        ...
        <div id="contents">
                ...
                <tr style="vertical-align:top;">
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
							...
							<!-- NEW FIELDS ---------------------------------------------- -->
                            <tr>
                                <td class="vertical">Industry:</td>
                                <td class="data"><?php $this->_($this->data['industry']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Country:</td>
                                <td class="data"><?php $this->_($this->data['cocountry']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Prospecting:</td>
                                <td class="data"><?php $this->_($this->data['prospecting']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Timezone:</td>
                                <td class="data"><?php $this->_($this->data['timezone']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Category:</td>
                                <td class="data"><?php $this->_($this->data['category']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Employees:</td>
                                <td class="data"><?php $this->_($this->data['employees']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Revenue:</td>
                                <td class="data">$&nbsp;<?php $this->_(number_format($this->data['revenue'],2,'.',',')); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">SIC:</td>
                                <td class="data"><?php $this->_($this->data['sic']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">NAICS:</td>
                                <td class="data"><?php $this->_($this->data['naics']); ?></td>
                            </tr>
                            <!-- END NEW FIELDS ------------------------------------------ -->
            ...
            <table class="sortable" width="925">
                <tr>
                    ...
                    <th align="left">Hiring Manager?</th>
                ...
                <?php if (count($this->contactsRSWC) != 0): ?>
                 <?php foreach ($this->contactsRSWC as $rowNumber => $contactsData): ?>
                    <tr id="ContactsDefault<?php echo($rowNumber) ?>" class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                        ...
                        <td valign="top" align="left"><?php $this->_($contactsData['IsHiringMgr']) ?></td>
			...
			<!-- CANDIDATES INFO -->
            <p class="note">Candidates</p>
            <table class="sortable" style="width:925px;overflow:auto;">
                <tr>
                    <th align="left" nowrap="nowrap">First Name</th>
                    <th align="left" nowrap="nowrap">Last Name</th>
                    <th align="left" nowrap="nowrap">Phone</th>
                    <th align="left" style="width:200px;word-break: break-all;">Key Skills</th>
                ...
                <?php if (count($this->candidatesRSWC) != 0): ?>
                 <?php foreach ($this->candidatesRSWC as $rowNumber => $candidatesData): ?>
                    <tr id="CandidatesDefault<?php echo($rowNumber) ?>" class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                        <td valign="top" align="left">
                            <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=show&amp;candidateID=<?php $this->_($candidatesData['candidateID']) ?>" class="<?php $this->_($candidatesData['linkClass']); ?>">
						...
						<td valign="top" align="left" style="width:200px;word-break: break-all;"><?php $this->_($candidatesData['keySkills']) ?></td>
						<td valign="top" align="left">availability</td>
                        <td valign="top" align="left"><?php $this->_($candidatesData['dateCreated']) ?></td>
                        <td valign="top" align="left"><?php $this->_($candidatesData['ownerAbbrName']); ?></td>
                        <td valign="top" align="center">
                            <?php if (!empty($candidatesData['email1'])): ?>
                                <a href="mailto:<?php $this->_($candidatesData['email1']); ?>" title="Send E-Mail (<?php $this->_($candidatesData['email1']); ?>)">
                                    <img src="images/actions/email.gif" width="16" height="16" alt="" class="absmiddle" border="0" />
                                </a>
                            <?php else: ?>
                                <img src="images/actions/email_no.gif" title="No E-Mail Address" width="16" height="16" alt="" class="absmiddle" border="0" />
                            <?php endif; ?>
                            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                                <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=edit&amp;candidateID=<?php $this->_($candidatesData['candidateID']) ?>">
                                    <img src="images/actions/edit.gif" width="16" height="16" class="absmiddle" alt="edit" border="0" />
                                </a>
                            <?php endif; ?>
                        </td>
               ...
               <?php endif; ?>
                ...
                <?php /* The following are hidden by default */ ?>
                <?php if (count($this->candidatesRSWC) != count($this->candidatesRS) && count($this->candidatesRS) != 0) : ?>
                 <?php foreach ($this->candidatesRS as $rowNumber => $candidateData): ?>
                    <tr id="ContactsFull<?php echo($rowNumber) ?>" class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>" style="display:none;">
                        <td valign="top" align="left">
                            <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=show&amp;candidateID=<?php $this->_($candidateData['candidateID']) ?>" class="<?php $this->_($candidateData['linkClass']); ?>">
                                <?php $this->_($candidateData['firstName']) ?>
                            </a>
                        </td>
                        <td valign="top" align="left">
                            <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=show&amp;candidateID=<?php $this->_($candidateData['candidateID']) ?>" class="<?php $this->_($candidateData['linkClass']); ?>">
                                <?php $this->_($candidateData['lastName']) ?>
                            </a>
                        </td>
                        <td valign="top" align="left"><?php $this->_($candidateData['phoneCell']) ?></td>
                        <td valign="top" align="left"><?php $this->_($candidateData['dateCreated']) ?></td>
                        <td valign="top" align="left"><?php $this->_($candidateData['ownerAbbrName']); ?></td>
                        <td valign="top" align="center">
                            <?php if (!empty($candidateData['email1'])): ?>
                                <a href="mailto:<?php $this->_($candidateData['email1']); ?>">
                                    <img src="images/actions/email.gif" width="16" height="16" alt="" class="absmiddle" border="0" title="Send E-Mail (<?php $this->_($candidateData['email1']); ?>)"/>
                                </a>
                            <?php else: ?>
                                <img src="images/actions/email_no.gif" title="No E-Mail Address" width="16" height="16" alt="" class="absmiddle" border="0" />
                            <?php endif; ?>
                            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                                <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=edit&amp;candidateID=<?php $this->_($candidateData['candidateID']) ?>">
                                    <img src="images/actions/edit.gif" width="16" height="16" class="absmiddle" alt="edit" border="0" />
                                </a>
                            <?php endif; ?>
                        </td>
			...
			<?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=add&amp;currentEmployer=<?php echo($this->data['name']); ?>" title="Add Candidate">
                    <img src="images/consider.gif" width="16" height="16" class="absmiddle" alt="add candidate" border="0" title="Add Candidate"/>&nbsp;Add Candidate
                </a>
            <?php endif; ?>
			<br clear="all" />
            <br />
			<!-- END OF CANDIDATES INFO -->
