                ...
                <table class="editTable" width="925">
                    ...
                    <!-- ------------------------------------------------------------- -->
                    			<tr>
                                    ...
                                    <td class="tdData">
                                        <!-- <input type="text" name="industry" id="industry"  class="inputbox" style="width: 150px" /> -->
                    					<select id="industry" name="industry" class="inputbox" style="width: 150px;">
                                            <option value=""></option>
                                            <?php foreach($this->industryRS as $rsIndex => $rsData) { ?>
												<option><?php $this->_($rsData['industry']); ?></option>
                                            <?php } ?>                                       
                                        </select>                                        
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <select tabindex="3" id="prospecting" name="prospecting" class="inputbox" style="width: 150px;">
                                        <option value=""></option>
                                        <option value="Suspect">Suspect</option>
                                        <option value="Prospect">Prospect</option>
                                        <option value="Lead">Lead</option>
                                        <option value="Opportunity">Opportunity</option>
                                        <option value="Farm Club">Farm Club</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="timezone" id="timezone"  class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                    ...
                                    <td class="tdData">                                        
                                        <select id="category" name="category" class="inputbox" style="width: 150px;">
                                            ...
                                            <?php foreach($this->categoryRS as $rsIndex => $rsData) { ?>
												<option><?php $this->_($rsData['category']); ?></option>
                                            <?php } ?>                                       
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="employees" id="employees"  class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="revenue" id="revenue"  class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                    			...
                    			<tr>
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="sic" id="sic"  class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>                                
                                <tr>
                                    <td class="tdVertical">
                                        <label id="naicsLabel" for="naics">NAICS:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="naics" id="naics"  class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                    <!-- =============================================================== -->
                </table>
