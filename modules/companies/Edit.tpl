                    ...
                    <tr>
                        <td valign="top" width="50%" height="285">
                            ...
                            <table class="editTable" width="100%">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="industrylLabel" for="industry">Industry:</label>
                                    </td>
                                    <td class="tdData">
                                        <!-- <input type="text" name="industry" id="industry" value="<?php $this->_($this->data['industry']); ?>" class="inputbox" style="width: 150px" /> -->
                                        <select id="industry" name="industry" class="inputbox" style="width: 150px;">
                                            <option value=""></option>
                                            <?php foreach($this->industryRS as $rsIndex => $rsData) { ?>
												<option <?php if(strtoupper($this->data['industry'])==strtoupper($rsData['industry'])) echo('selected'); ?> ><?php $this->_($rsData['industry']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="Country" id="Country" value="<?php $this->_($this->data['cocountry']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                        <label id="prospectingLabel" for="prospecting">Prospecting:</label>
                                    </td>
                                    <td class="tdData">
                                        <select id="prospecting" name="prospecting" class="inputbox" style="width: 150px;">
                                            <option <?php if($this->data['prospecting'] == '') echo('selected'); ?> value=""></option>
                                            <option <?php if($this->data['prospecting'] == 'Suspect') echo('selected'); ?> value="Suspect">Suspect</option>
                                            <option <?php if($this->data['prospecting'] == 'Prospect') echo('selected'); ?> value="Prospect">Prospect</option>
                                            <option <?php if($this->data['prospecting'] == 'Lead') echo('selected'); ?> value="Lead">Lead</option>
                                            <option <?php if($this->data['prospecting'] == 'Opportunity') echo('selected'); ?> value="Opportunity">Opportunity</option>
                                            <option <?php if($this->data['prospecting'] == 'Farm Club') echo('selected'); ?> value="Farm Club">Farm Club</option>
                                            <option <?php if($this->data['prospecting'] == 'No-Opportunity') echo('selected'); ?> value="No-Opportunity">No-Opportunity</option>
                                            <option <?php if($this->data['prospecting'] == 'Out-of-Area') echo('selected'); ?> value="Out-of-Area">Out-of-Area</option>
                                            <option <?php if($this->data['prospecting'] == 'Avoid') echo('selected'); ?> value="Avoid">Avoid</option>
                                            <option <?php if($this->data['prospecting'] == 'Restricted') echo('selected'); ?> value="Restricted">Restricted</option> 
                                       </select> 
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                        <label id="timezoneLabel" for="timezone">Timezone:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="timezone" id="timezone" value="<?php $this->_($this->data['timezone']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                    ...
                                    <td class="tdData">                                        
                                        <select id="category" name="category" class="inputbox" style="width: 150px;">
                                            <option value=""></option>
                                            <?php foreach($this->categoryRS as $rsIndex => $rsData) { ?>
												<option <?php if(strtoupper($this->data['category'])==strtoupper($rsData['category'])) echo('selected'); ?> ><?php $this->_($rsData['category']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                        <label id="employeesLabel" for="employees">Employees:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="employees" id="employees" value="<?php $this->_($this->data['employees']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                        <label id="revenueLabel" for="revenue">Revenue:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="revenue" id="revenue" value="<?php $this->_($this->data['revenue']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td class="tdVertical">
                                        <label id="sicLabel" for="sic">SIC:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="sic" id="sic" value="<?php $this->_($this->data['sic']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td class="tdVertical">
                                        <label id="naicsLabel" for="revenue">NAICS:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="naics" id="naics" value="<?php $this->_($this->data['naics']); ?>" class="inputbox" style="width: 150px" />
                                    </td>
                                </tr>
