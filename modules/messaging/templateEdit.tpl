...
?>
        ...
        <div id="contents">
            <form action="<?php echo(CATSUtility::getIndexName()); ?>?m=messaging&a=templateEdit&id=<?php $this->_($this->data['templateID']); ?>" method="post">
            <table>
                <tr>
                    <td width="3%">
                        <img src="images/candidate.gif" width="24" height="24" border="0" alt="Candidates" style="margin-top: 3px;" />&nbsp;
                    </td>
                    <td><h2>Messaging: Edit Template Form</h2></td>
               </tr>
            </table>

            <p class="note"> Edit Template Form</p>

            <input type="hidden" value="1" name="postback" id="postback">
            <input type="hidden" value="<?php $this->_($this->data['templateID']); ?>" name="id" id="id" class="inputbox" style="width: 800px;">
                        ...
                        <table class="detailsInside" height="100%">
                            <tr>
                                ...
                                <td class="data" colspan="3">
                                    <input type="text" value="<?php $this->_($this->data['title']); ?>" name="title" id="title" class="inputbox" style="width: 800px;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="data" colspan="3">
									<textarea style="width: 800px; height: 200px;" name="content" id="content" class="ckeditor" ><?php echo $this->data['content']; ?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="data" colspan="3">
									<select name="signature" id="signature">
										<option value="0"<?php echo $this->data['emailSignature'] == 0 ? ' selected' : '' ; ?>>No</option>
										<option value="1"<?php echo $this->data['emailSignature'] == 1 ? ' selected' : '' ; ?>>Yes</option>
									</select>
                                </td>
                            </tr>
