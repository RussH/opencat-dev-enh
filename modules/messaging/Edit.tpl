...
?>
        ...
        <div id="contents">
            <form name="editMessageForm" id="editMessageForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=messaging&a=edit&messageID=<?php $this->_($this->data['messagingID']); ?>" method="post">
            <table>
                <tr>
                    <td width="3%">
                        <img src="images/candidate.gif" width="24" height="24" border="0" alt="Candidates" style="margin-top: 3px;" />&nbsp;
                    </td>
                    <td><h2>Messaging: Edit <?php echo $message_stat_display; ?> Form</h2></td>
               </tr>
            </table>

            <p class="note"> Edit <?php echo ucwords($message_stat_display); ?> Form</p>
                        ...
                        <table class="detailsInside" height="100%">
                            <tr>
                                ...
                                <td class="data" colspan="3">
									...
									<div class="inputbox" id="contactBox" style="display:block; width: 800px; height: auto; padding: 10px 0px; border:0;">
									<?php
										$contact_list = '';
										if(isset($this->contactlist)){
											foreach($this->contactlist as $val){
												$lastName = $val['lastName'];
												$firstName = $val['firstName'];
												$email1 = (isset($val['email1']) && strlen($val['email1']) > 0 ? $val['email1'] : '');
												$email2 = (isset($val['email2']) && strlen($val['email2']) > 0 ? $val['email2'] : '');
												$emailTextDisplay = ( strlen($email1) > 0 ? $email1 : $email2 );
												$textDisplay = $lastName.', '.$firstName.' ('.$emailTextDisplay.')';
												echo '<div id="cEntry'.$val['ID'].'" class="contactEntry"><b>'.$textDisplay.'</b></div>';
												$contact_list .= $val['ID'].',';
											}
                                    ...
                                    <input type="hidden" value="<?php echo $contact_list; ?>" name="contactlist" id="contactlist">
                                    <input type="hidden" value="" name="contactgroup" id="contactgroup">
									<input type="hidden" value="<?php $this->_($this->data['messagingID']); ?>" name="messageID" id="messageID">
                            ...
                            <tr>
                                ...
                                <td class="data" colspan="3">
                                    <input type="text" value="<?php $this->_($this->data['subject']); ?>" name="subject" id="subject" class="inputbox" style="width: 800px; padding: 10px;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="data" colspan="3">
									<textarea style="width: 815px; height: 200px;" name="message" id="message" class="ckeditor" ><?php echo $this->data['message']; ?></textarea>
                                </td>
                            </tr>
							...
							<tr>
								...
								<td class="data" colspan="3">
									<input type="button" class="button" name="back"   id="back"   value="Back to Details" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=messaging&stat=<?php $this->_($this->data['status']); ?>');" />&nbsp;
									...
									<input type="submit" class="button" name="save" id="save" value="Update" />&nbsp;
