...
class ReportsUI extends UserInterface
{
    ...
    private function reports()
    {
        ...
        $statisticsData['totalActivities']     = $statistics->getActivityCount(TIME_PERIOD_TODATE);
        $statisticsData['activitiesToday']     = $statistics->getActivityCount(TIME_PERIOD_TODAY);
        $statisticsData['activitiesYesterday'] = $statistics->getActivityCount(TIME_PERIOD_YESTERDAY);
        $statisticsData['activitiesThisWeek']  = $statistics->getActivityCount(TIME_PERIOD_THISWEEK);
        $statisticsData['activitiesLastWeek']  = $statistics->getActivityCount(TIME_PERIOD_LASTWEEK);
        $statisticsData['activitiesThisMonth'] = $statistics->getActivityCount(TIME_PERIOD_THISMONTH);
        $statisticsData['activitiesLastMonth'] = $statistics->getActivityCount(TIME_PERIOD_LASTMONTH);
        $statisticsData['activitiesThisYear']  = $statistics->getActivityCount(TIME_PERIOD_THISYEAR);
        $statisticsData['activitiesLastYear']  = $statistics->getActivityCount(TIME_PERIOD_LASTYEAR);
