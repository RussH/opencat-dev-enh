                ...
                <tr>
                    <td width="320">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesToday']); ?>&nbsp;&nbsp;</td>
                            </tr>
                    ...
                    <td width="320">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesYesterday']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
			<td align="left">New Job Orders</td>
                    ...
                    <td width="320">
                        <table class="statisticsTable" width="300">
                            <tr>
                             ...
                             <tr class="oddTableRow">
                                <td align="left">New Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesThisWeek']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
                                <td align="left">New Job Orders</td>
                ...
                <tr>
                    ...
                    <td>
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activites</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesLastWeek']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
                                <td align="left">New Job Orders</td>
                    ...
                    <td width="320" valign="top">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activites</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesThisMonth']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
                                <td align="left">New Job Orders</td>
                    ...
                    <td width="320" valign="top">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesLastMonth']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
                                <td align="left">New Job Orders</td>
                ...
                <tr>
                    ...
                    <td width="320" valign="top">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesThisYear']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
                                <td align="left">New Job Orders</td>
                    ...
                    <td width="320" valign="top">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">New Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['activitiesLastYear']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
                                <td align="left">New Job Orders</td>
                    ...
                    <td width="320" valign="top">
                        <table class="statisticsTable" width="300">
                            ...
                            <tr class="oddTableRow">
                                <td align="left">Total Activities</td>
                                <td align="right"><?php $this->_($this->statisticsData['totalActivities']); ?>&nbsp;&nbsp;</td>
                            </tr>
                            <tr class="evenTableRow">
