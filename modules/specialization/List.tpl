...
<?php TemplateUtility::printTabs($this->active); ?>
    ...
    <div id="main">
        ...
        <div id="contents"<?php echo !$this->totalSpecializations ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            <?php if ($this->totalSpecializations): ?>
            <table width="100%">
                <tr>
                    <td width="3%">
                        <img src="images/contact.gif" width="24" height="24" border="0" alt="Contacts" style="margin-top: 3px;" />&nbsp;
                    </td>
                    <td><h2>Specialization: Home</h2></td>
                    <td align="right">
                        <form name="specializationViewSelectorForm" id="specializationViewSelectorForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get">
                            <input type="hidden" name="m" value="settings" />
                            <input type="hidden" name="a" value="specializationPanel" />
            ...
            <p class="note">
                <span style="float:left;">
                    Specification - Page <?php echo($this->dataGrid->getCurrentPageHTML()); ?>
            ...
            <div style="display:block;">
                <span style="float:left;">
					...
					&nbsp;|&nbsp;
                    <a href="<?php echo CATSUtility::getIndexName(); ?>?m=specialization&amp;a=addnew">
                    [+] Add
                    </a>
