...
<?php if(intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE) { 
		 TemplateUtility::printModalHeader('Candidates', array(), 'Add Candidates to Job Order Pipeline'); 
      } else {
      	 TemplateUtility::printModalHeader('Candidates', array(), 'Job Application');  
      }
?>
