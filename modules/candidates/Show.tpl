        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) {echo('My Profile - '.$this->data['firstName'].' '.$this->data['lastName']);} else {echo('Candidates: Candidate Details');}?><?php ?></h2></td>
               </tr>
            </table>

            <p class="note"><?php if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) {echo('Profile Details');} else {echo('Candidate Details');}?><?php ?></p>
                    ...
                    <?php endif; ?>
                        <table class="detailsInside" height="100%">
                            <tr>
                                ...
                                <td class="data">
                                    <span style="font-weight: bold;" class="<?php echo($this->data['titleClass']); ?>">
                                        ...
                                        <?php endif; ?>
                                        <?php if(intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE) { TemplateUtility::printSingleQuickActionMenu(DATA_ITEM_CANDIDATE, $this->data['candidateID']); } ?>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="data"><?php
                                 if(strlen($this->data['skype_id'])>0) echo '<a href="callto://'.$this->data['skype_id'].'">';
                                 $this->_($this->data['skype_id']); 
                                 if(strlen($this->data['skype_id'])>0) echo '</a>';
                                 ?></td>
                            </tr>
                            ...
                            <tr>
                                <td class="vertical">Contract Type</td>
                                <td class="data"><?php $this->_($this->data['contact_type']); ?></td>
                            </tr>
                            <?php if(intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE) { ?>
							
                            <tr>
                                <td class="vertical">CR Classification:</td>
                                <td class="data"><?php $this->_($this->data['crclassification']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">Speech:</td>
                                <td class="data"><?php $this->_($this->data['communication']); ?></td>
                            </tr>
							<?php } ?>
                            <tr>
                                <td class="vertical">Eligibility:</td>
                                <td class="data"><?php $this->_($this->data['eligibility']); ?></td>
                            </tr>
                            
                            <tr>
                                <td class="vertical">Target Job Zone:</td>
                                <td class="data"><?php $this->_($this->data['jobzone']); ?></td>
                            </tr>
                            ...
                            <tr>
                                <td class="vertical">LinkedIn Profile:</td>
                                <td class="data">
...
<?php if (!$this->isPopup): ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_DELETE && intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE): ?>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
            <?php if ($this->privledgedUser && intval($_SESSION['CATS']->getAccessLevel()) != ACCESS_LEVEL_CANDIDATE): ?>
            ...
            <?php endif; ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                <a id="list_link" href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=lists&amp;a=addToListFromDatagridModal&amp;dataItemType=100&amp;candidateID=<?php echo($this->candidateID); ?>', 450, 350, null); return false;">
                    <img src="images/actions/edit.gif" width="16" height="16" class="absmiddle" alt="edit" border="0" />&nbsp;Add to List
                </a>
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
<?php endif; ?>
            ...
            <?php } else { ?>
                <p class="note">Job Applications</p> 
            <?php } ?>
...
<?php if (!$this->isPopup): ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                <a href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=considerForJobSearch&amp;candidateID=<?php echo($this->candidateID); ?>', 750, 390, null); return false;">
                    <img src="images/consider.gif" width="16" height="16" class="absmiddle" alt="Add to Pipeline" border="0" />&nbsp;<?php   if(intval($_SESSION['CATS']->getAccessLevel()) == ACCESS_LEVEL_CANDIDATE) {echo('Apply for a Job');} else {echo('Add This Candidate to Job Order Pipeline');}?></a>
            <?php endif; ?>
<?php endif; ?>
            <br clear="all" />
            <br />
...
<?php endif; ?>
                ...
                <?php foreach ($this->activityRS as $rowNumber => $activityData): ?>
                    <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                        ...
                        <td align="left" valign="top" id="activityNotes<?php echo($activityData['activityID']); ?>">
							<?php if ($activityData['dataItemType'] == DATA_ITEM_MESSAGING_CANDIDATE) { ?>
								<a href="<?php echo(CATSUtility::getIndexName()); ?>?m=messaging&a=show&messageID=<?php $this->_($activityData['message_id']); ?>"><?php echo $activityData['notes']; ?></a>
							<?php } else { 
								echo $activityData['notes'];
							} ?>
						</td>
<?php if (!$this->isPopup): ?>
                        <td align="center" >
