...
<?php if ($this->isModal): ?>
    <?php TemplateUtility::printModalHeader('Candidates', array('modules/candidates/validator.js', 'js/suggest.js', 'js/addressParser.js', 'js/listEditor.js',  'js/candidate.js', 'js/candidateParser.js'), 'Add New Candidate to This Job Order Pipeline'); ?>
<?php else: ?>
    <?php TemplateUtility::printHeader('Candidates', array('modules/candidates/validator.js', 'js/suggest.js', 'js/addressParser.js', 'js/listEditor.js',  'js/candidate.js', 'js/candidateParser.js')); ?>
                ...
                <table class="editTable" width="<?php if ($this->isModal): ?>100%<?php else: ?>925<?php endif; ?>">
                    ...
                    <tr>
                        ...
                        <td rowspan="12" align="center" valign="top">
                        	<textarea id="photo64" name="photo64" style="display:none"><?php echo($this->photo64);?></textarea>
                        	<input type="hidden" name="resumePhotoID" id="resumePhotoID" value="<?php echo($this->associatedResumePhoto);?>" />
                            <input type="hidden" name="resumePhotoType" id="resumePhotoType" value="<?php echo($this->associatedResumePhotoType);?>" />
                            <?php if(strlen($this->associatedResumePhoto.'')>0) { ?>
                            	<img id="photo_preview" src="" align="left" width="125" style="height:auto; display:block; border:1px solid #000" />
                                <div style="clear:both"></div>
                                <p>&nbsp;</p>
                                <script language="javascript">									
									var src = "data:image;base64,";
									src = src + document.getElementById("photo64").value;
									document.getElementById("photo_preview").setAttribute("src", src);
								</script>
                            <?php } ?>
                            <?php if ($this->isParsingEnabled): ?>
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="webSiteLabel" for="webSite">LinkedIn Profile:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="skype_idLabel" for="skype_id">Skype ID:</label>
                        </td>
                        <td class="tdData">
                            <input type="text" tabindex="8" name="skype_id" id="skype_id" class="inputbox" style="width: 150px" value="<?php if (isset($this->preassignedFields['skype_id'])) $this->_($this->preassignedFields['skype_id']); ?>" />
                        </td>
                    </tr>
                    ...
                    <!--<tr>
                        ...
                        <td class="tdData">
                            <select id="eligibility" name="eligibility" class="inputbox" style="width:300px;">
                                <option value=""></option>
                                <option value="Canadian Citizen">Canadian Citizen</option>
                                <option value="Canadian Permanent Resident">Canadian Permanent Resident</option>
                                <option value="Canadian Work Permit Holder">Canadian Work Permit Holder</option>
                ...
                <table class="editTable" width="<?php if ($this->isModal): ?>100%<?php else: ?>925<?php endif; ?>">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
							...
							<input type="text" tabindex="<?php echo($tabIndex++); ?>" name="currentEmployer" id="currentEmployer" value="<?php if (isset($this->preassignedFields['currentEmployer'])) $this->_($this->preassignedFields['currentEmployer']); ?>" class="inputbox" style="width: 158px" onFocus="suggestListActivate('getCompanyNames', 'currentEmployer', 'CompanyResults', 'companyID', 'ajaxTextEntryHover', 0, '<?php echo($this->sessionCookie); ?>', 'helpShim');" />
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" tabindex="<?php echo($tabIndex++); ?>" name="currentPay" id="currentPay" class="inputbox" style="width: 158px" value="<?php if (isset($this->preassignedFields['currentPay'])) $this->_($this->preassignedFields['currentPay']); ?>" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" tabindex="<?php echo($tabIndex++); ?>" name="desiredPay" id="desiredPay" class="inputbox" style="width: 158px" value="<?php if (isset($this->preassignedFields['desiredPay'])) $this->_($this->preassignedFields['desiredPay']); ?>" />
                        </td>
                    </tr>
