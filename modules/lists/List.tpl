...
<?php TemplateUtility::printHeader('Lists', array( 'js/highlightrows.js', 'js/sweetTitles.js', 'js/export.js', 'js/dataGrid.js', 'js/lists.js')); ?>
...
<?php TemplateUtility::printTabs($this->active); ?>
    <div id="main">
        ...
        <td align="left" valign="middle"><a href="#" onclick="showPopWin('index.php?m=lists&amp;a=emailForJobSearchSelectJob&amp;candidateIDArrayStored=<?php echo($this->candidateIDArrayStored);?>', 750, 390, null); return false;">Email Job Order to Candidates on this List</a></td>
        </tr>        
        </tbody>
        </table>
    </div>
