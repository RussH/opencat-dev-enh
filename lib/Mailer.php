...
class Mailer
{
        ...
        $signature = true)
    {
        ...
        if ($isHTML)
        {
            ...
            if ($signature)
            {
                $body .= "\n<br />\n<br /><span style=\"font-size: 10pt;\">Powered by <a href=\"http://www.clearroad.it\" alt=\"CATS "
                    . "Applicant Tracking System\">CATS</a></span>";
            }
			...
			$this->_mailer->Body = '<div style="font: normal normal 12px Arial, Tahoma, sans-serif">' . $body . '</div>';
        ...
        else
        {
            ...
            if ($signature)
            {
                $body .= "\n\nPowered by CATS (http://www.clearroad.it)";
            }
			*/
