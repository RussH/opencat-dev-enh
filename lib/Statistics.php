...
class Statistics
{
    ...
    /**
     * Returns the total number of activities created in the given period.
     *
     * @param flag statistics period flag
     * @return integer candidate count
     */
    public function getActivityCount($period)
    {
        $criterion = $this->makePeriodCriterion('date_created', $period);
    ...
    /**
     * Returns all activities in the given period.
     *
     * @param flag statistics period flag
     * @return array assoc activities
     */
    public function getUsersActivitiesByPeriod($period)
    {
        $criterion = $this->makePeriodCriterion(
